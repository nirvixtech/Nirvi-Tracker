...
const selectClassName =
  "h-10 w-full appearance-none rounded-xl border border-slate-100 bg-slate-50 px-3 pr-10 text-sm text-slate-700 shadow-[0_1px_2px_rgba(15,23,42,0.03)] outline-none transition focus:border-slate-200 focus:ring-2 focus:ring-slate-100 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100 dark:focus:border-slate-700 dark:focus:ring-slate-800";
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-3">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="rounded-full bg-blue-100 px-3 py-1 text-[11px] trykker-regular uppercase tracking-[0.16em] text-blue-700 dark:bg-blue-950/60 dark:text-blue-300">
                    {mode === "create" ? "New Project" : "Edit Project"}
                  </span>
                  <span className="rounded-full bg-slate-200 px-3 py-1 text-[11px] trykker-regular uppercase tracking-[0.16em] text-slate-600 dark:bg-slate-800 dark:text-slate-300">
                    {formData.status}
                  </span>
                </div>
                <div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      className="max-h-72 w-80 rounded-xl border border-slate-200 bg-white p-2 shadow-xl dark:border-slate-700 dark:bg-slate-900"
                      align="start"
                    >
